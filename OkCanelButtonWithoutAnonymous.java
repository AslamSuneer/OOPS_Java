...
public class ButtonDisplay extends JFrame {
    ...
    ButtonDisplay(){
        ...
        jbtOK.addActionListener(new ButtonMessage()); // Button message listener
        jbtCancel.addActionListener(new ButtonMessage()); // Button message listener
    ...
    class ButtonMessage implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            JButton source = (JButton) e.getSource();
            String command = source.getText();
            jlab.setText(command + " Pressed");
        }
    }
